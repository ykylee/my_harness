...
- 상태: stable
- 최종 수정일: 2026-06-10 (D-62 + D-62 W19-1 + D-63 W20, **W17 누락분 = 0건 정정** + **TC-W17-002 test fail 복구 (AuthStore 주입)** + **F-3 Ollama native cascade**. W17 original 4 commit 모두 main 머지 확인. W19-1 = store 주입. W20 = `probe_local_models` 2-stage cascade (Ollama native /api/tags → OpenAI compat /v1/models). 4 L1 + 3 L2 = 7 신규 test, 110 llm + 10 w16_add_local tests / 0 fail)
