...
- 상태: stable
- 최종 수정일: 2026-06-11 (**D-75 Plan A-2 T-v5-sync-1 5.1 적응** — 5.1 의 22 file 직접 mirror 가 아닌, **개념만 차용** + my_harness 의 5 separate MCP 프로토타입에 codex/opencode spawn 가이드 적응. 4 file 1 commit (5d9ad1b dual push). 5.1 scope 측정 결과 my_harness ↔ upstream divergence 가 D-73 추정보다 훨씬 큼. 이전: D-74 LLM Wiki 정상화 + D-73 4-plan split)
