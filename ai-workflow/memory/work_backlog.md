...
- 상태: stable
- 최종 수정일: 2026-06-11 (**D-77 Plan B-2 T-v5-sync-1 5.2 bootstrap_lib refactor (2204 lines 분해)** — 11 file 신규 mirror (3,718 + 1,310 = 5,028 lines) + 1 file replace (2204 → 55 lines shim) + 1 file backup (legacy.bak) + 2 test file SOURCE_ROOT fix. 14 file, 1 commit. `python -m bootstrap_lib --help` 정상 출력. 이전: D-76 Plan B-1 + D-75 Plan A-2 + D-74 LLM Wiki 정상화)
